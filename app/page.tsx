...
const supabaseUrl = 'https://gnccubgfyolpqyfciibj.supabase.co';
const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'your-anon-key-here';  // Replace with real key in env
